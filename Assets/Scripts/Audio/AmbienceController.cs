    ...
    namespace Audio {
        ...
        public class AmbienceController : MonoBehaviour
        {
            ...
            private class AudioJob {
                ...
                public AudioJob(AudioAction _action, Ambience _type, bool _fade, float _delay) {
                    action = _action;
                    type = _type;
                    fade = _fade;
                    delay = _delay;
...
#region Public Functions
            public void PlayAudio(Ambience _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.START, _type, _fade, _delay));
            }

            public void StopAudio(Ambience _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.STOP, _type, _fade, _delay));
            }

            public void RestartAudio(Ambience _type, bool _fade=false, float _delay=0.0F) {
...
#region Private Functions
            ...
            private void RemoveJob(Ambience _type) {
            ...
            private void RemoveConflictingJobs(Ambience _type) {
                ...
                Ambience _conflictAudio = Ambience.None;
                foreach (DictionaryEntry _entry in m_JobTable) {
                    Ambience _audioType = (Ambience)_entry.Key;
                ...
                if (_conflictAudio != Ambience.None) {
            ...
            private AudioTrack GetAudioTrack(Ambience _type, string _job="") {
            ...
            private AudioClip GetAudioClipFromAudioTrack(Ambience _type, AudioTrack _track) {
                foreach (AudioObject _obj in _track.audio) {
                    if (_obj.type == _type) {
                        return _obj.clip;
                    }
