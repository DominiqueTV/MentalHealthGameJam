    ...
    namespace Audio {
        ...
        public class SfxController : MonoBehaviour
        {
            ...
            private class AudioJob {
                ...
                public AudioJob(AudioAction _action, SFX _type, bool _fade, float _delay) {
                    action = _action;
                    type = _type;
                    fade = _fade;
                    delay = _delay;
...
#region Public Functions
            public void PlayAudio(SFX _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.START, _type, _fade, _delay));
            }

            public void StopAudio(SFX _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.STOP, _type, _fade, _delay));
            }

            public void RestartAudio(SFX _type, bool _fade=false, float _delay=0.0F) {
...
#region Private Functions
            ...
            private void RemoveJob(SFX _type) {
            ...
            private void RemoveConflictingJobs(SFX _type) {
                ...
                SFX _conflictAudio = SFX.None;
                foreach (DictionaryEntry _entry in m_JobTable) {
                    SFX _audioType = (SFX)_entry.Key;
            ...
            private AudioTrack GetAudioTrack(SFX _type, string _job="") {
            ...
            private AudioClip GetAudioClipFromAudioTrack(SFX _type, AudioTrack _track) {
                foreach (AudioObject _obj in _track.audio) {
                    if (_obj.type == _type) {
                        return _obj.clip;
                    }
