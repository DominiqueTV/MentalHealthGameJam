    ...
    namespace Audio {
        ...
        public class MusicController : MonoBehaviour
        {
            ...
            private class AudioJob {
                ...
                public AudioJob(AudioAction _action, Music _type, bool _fade, float _delay) {
                    action = _action;
                    type = _type;
                    fade = _fade;
                    delay = _delay;
...
#region Public Functions
            public void PlayAudio(Music _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.START, _type, _fade, _delay));
            }

            public void StopAudio(Music _type, bool _fade=false, float _delay=0.0F) {
                AddJob(new AudioJob(AudioAction.STOP, _type, _fade, _delay));
            }

            public void RestartAudio(Music _type, bool _fade=false, float _delay=0.0F) {
...
#region Private Functions
            ...
            private void RemoveJob(Music _type) {
            ...
            private void RemoveConflictingJobs(Music _type) {
                ...
                Music _conflictAudio = Music.None;
                foreach (DictionaryEntry _entry in m_JobTable) {
                    Music _audioType = (Music)_entry.Key;
            ...
            private AudioTrack GetAudioTrack(Music _type, string _job="") {
            ...
            private AudioClip GetAudioClipFromAudioTrack(Music _type, AudioTrack _track) {
                foreach (AudioObject _obj in _track.audio) {
                    if (_obj.type == _type) {
                        return _obj.clip;
                    }
